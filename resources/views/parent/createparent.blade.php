@extends('enfant.app') <!-- Replace with your actual layout -->
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb" style="background-color: #ffffff">
        ...
        <li class="breadcrumb-item"><a href="/parents" style="color :#2e90d6">Liste des Parents</a></li>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Ajouter Parent') }}</div>
